...
CUDA_VISIBLE_DEVICES=0 python pose2image.py --seed 37837 --timesteps 100 --prompt "two young men, realistic color photo" --pose_ref "./test_imgs/couple.jpeg" --id_ref "./test_imgs/id3.png"
